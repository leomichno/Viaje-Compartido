...
public class ConductorController {
    ...
    @PostMapping
    public Conductor crearConductor(@RequestBody ConductorDTO dto){
        Conductor conductor = new Conductor(dto.getNombre(),dto.getSaldo(),dto.getTipoUsuario(), dto.getVehiculo());
